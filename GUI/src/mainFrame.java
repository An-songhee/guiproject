...
public class mainFrame {
	...
	public JButton drawPreviousButton(ImagePanel bgPanel) {
		JButton button = this.makeImageButton("previous3.jpg", "previous3.jpg");
		button.setBounds(520, 631, 60, 49);
		button.setBorderPainted(false);
		button.setFocusPainted(false);
		button.setBackground(Color.BLACK);
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				if (page == 0) {
					button.setRolloverIcon(new ImageIcon("./image/previous3.jpg"));
				} else {
					button.setRolloverIcon(new ImageIcon("./image/previous3.jpg"));
				}
			}
	...
	public JButton drawNextButton(ImagePanel bgPanel) {
		JButton button = this.makeImageButton("next3.jpg", "next3.jpg");
		button.setBounds(710, 631, 60, 49);
		button.setBorderPainted(false);
		button.setFocusPainted(false);
		button.setBackground(Color.BLACK);
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				if (page == (page_max - 1) * 5) {
					button.setRolloverIcon(new ImageIcon("./image/next3.jpg"));
				} else {
					button.setRolloverIcon(new ImageIcon("./image/next3.jpg"));
				}
			}
