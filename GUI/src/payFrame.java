...
public class payFrame {
	...
	public class Reservation {
		...
		public Reservation(int i, int screeningId2, int accountId2, String groupId, String date, int seatId, boolean canceled) {
			this.movieId = i;
		...
		// 여기에 getter, setter 메소드를 추가해야 합니다.
		// 예: 
	...
	public void pay() {
		...
		for (Integer seat : my.selectedSeat) {
			Reservation reservation = new Reservation(my.getmovieId(), my.ScreeningId, user.accountId, uuid, today, seat, false);
